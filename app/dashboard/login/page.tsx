        ...
        : resolvedSearchParams.error === "email_delivery_failed"
          ...
          : resolvedSearchParams.error === "rate_limited"
            ...
            : resolvedSearchParams.error === "auth_disabled"
              ? "Tenant sign-in is not enabled for this environment."
              : null;
      ...
      <section className="card console-card-shell">
        <div className="console-content">
          <section className="console-section">
            ...
            <h1>Sign in to your tenant dashboard</h1>
            <p className="subtle-text">
              Enter the email address configured as the tenant contact to receive a one-time
            ...
            {resolvedSearchParams.email_sent === "1" ? (
              <p className="console-success-text">
                If that email address is configured for a tenant, we sent a one-time sign-in link.
              </p>
            ) : null}
            ...
            <form action={appPath("/api/dashboard/login")} className="console-content" method="post">
              <Input
                autoComplete="email"
                info="Use the tenant contact email. The link expires after 15 minutes and can only be used once."
                label="Email address"
                name="email"
                required
                type="email"
